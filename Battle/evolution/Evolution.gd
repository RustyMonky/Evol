...
func choose_form():
	if evolutions[current_choice].name == 'Defense':
		...
		gameData.player.stats_sprite = "res://assets/sprites/forms/sheets-48x48/baseDefSheet.png"
		...
		gameData.player.stats_sprite = "res://assets/sprites/forms/sheets-48x48/baseSpdSheet.png"
		...
		gameData.player.stats_sprite = "res://assets/sprites/forms/sheets-48x48/baseStrSheet.png"
		...
		gameData.player.stats_sprite = "res://assets/sprites/forms/sheets-48x48/baseFireSheet.png"
		...
		gameData.player.stats_sprite = "res://assets/sprites/forms/sheets-48x48/baseWaterSheet.png"
		...
		gameData.player.stats_sprite = "res://assets/sprites/forms/sheets-48x48/baseGrassSheet.png"
